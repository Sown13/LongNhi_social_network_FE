    ...
    return (
        <div className={"user-header"}>
                ...
                <div className={"user-action"}>
                    ...
                    {relationship.sourceUser.userId === 0 ?
                        user.userId == userId ?
                            ...
                            : <div>
                              <Link to={"/login"} ><button> Thêm bạn</button></Link>
                                <Link to={"/login"} ><button>Nhắn tin</button></Link>
            ...
            <div className={`user-navbar`}>
                <Link to={`/guest/users/${userId}`}>Tường</Link>
                <Link to={`/guest/users/${userId}/aboutHeader`}>Giới thiệu</Link>
                <Link to={`/guest/users/${userId}/friend`}>Bạn bè</Link>
